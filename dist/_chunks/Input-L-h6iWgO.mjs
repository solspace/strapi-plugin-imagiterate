...
import { Field, Flex, Card, CardHeader, Typography, CardSubtitle, CardBody, Grid, Box, CarouselInput, CarouselSlide, CarouselImage, Button, Textarea, Modal } from "@strapi/design-system";
import { useParams } from "react-router-dom";
import { P as PLUGIN_ID } from "./index-Cw1Sdw-u.mjs";
                  ...
                  /* @__PURE__ */ jsx(Grid.Item, { col: 7, xs: 12, children: /* @__PURE__ */ jsxs(
                    Box,
                    {
                      ...
                      children: [
                        ...
                        embeddedFromWidget && /* @__PURE__ */ jsx(Box, { marginTop: 2, children: /* @__PURE__ */ jsx(
                          Button,
                          {
                            onClick: handleSubmit,
                            disabled: !prompt.trim() || isProcessing || images.length === 0,
                            loading: isProcessing,
                            children: /* @__PURE__ */ jsx(Language, { id: "addNewAsset" })
                          }
                        ) })
                      ]
                    }
...
//# sourceMappingURL=Input-L-h6iWgO.mjs.map
