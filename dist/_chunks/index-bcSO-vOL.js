...
const index = {
  register(app) {
    ...
    app.widgets.register({
      ...
      component: async () => {
        const component = await Promise.resolve().then(() => require("./ImagiterateWidget-BMSRqxKD.js"));
    ...
    app.customFields.register({
      ...
      icon: AiIcon,
      components: {
        Input: async () => Promise.resolve().then(() => require("./Input-mXFfkm8i.js")).then((module2) => ({
...
exports.index = index;
//# sourceMappingURL=index-bcSO-vOL.js.map
