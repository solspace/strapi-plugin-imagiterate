...
const index = {
  register(app) {
    ...
    app.widgets.register({
      ...
      component: async () => {
        const component = await Promise.resolve().then(() => require("./ImagiterateWidget-BP9nZF_P.js"));
    ...
    app.customFields.register({
      ...
      icon: AiIcon,
      components: {
        Input: async () => Promise.resolve().then(() => require("./Input-C1thzi7K.js")).then((module2) => ({
...
exports.index = index;
//# sourceMappingURL=index-AJbKPc2l.js.map
