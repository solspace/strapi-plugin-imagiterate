...
const index = {
  register(app) {
    ...
    app.widgets.register({
      ...
      component: async () => {
        const component = await Promise.resolve().then(() => require("./ImagiterateWidget-DCpgCC_B.js"));
    ...
    app.customFields.register({
      ...
      icon: AiIcon,
      components: {
        Input: async () => Promise.resolve().then(() => require("./Input-DeJczybE.js")).then((module2) => ({
...
exports.index = index;
//# sourceMappingURL=index--y7wlew5.js.map
