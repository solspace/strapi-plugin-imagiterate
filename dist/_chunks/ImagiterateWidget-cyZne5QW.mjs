...
import { Flex, Popover, Box, Typography, Button, LinkButton, Link, Portal, Alert, Field, Loader, SubNav, Badge } from "@strapi/design-system";
...
import { Input } from "./Input-CdoRyqhJ.mjs";
...
const ImagiterateWidget2 = () => {
  ...
  if (!images || images.length === 0) return /* @__PURE__ */ jsx(Widget.NoData, {});
  return /* @__PURE__ */ jsx(
    Input,
    {
      images,
...
export {
  ImagiterateWidget2 as default
};
//# sourceMappingURL=ImagiterateWidget-cyZne5QW.mjs.map
