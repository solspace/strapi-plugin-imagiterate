...
const index = {
  register(app) {
    ...
    app.widgets.register({
      ...
      component: async () => {
        const component = await Promise.resolve().then(() => require("./ImagiterateWidget-DN8bqSDa.js"));
    ...
    app.customFields.register({
      ...
      icon: AiIcon,
      components: {
        Input: async () => Promise.resolve().then(() => require("./Input-Cud0Ket5.js")).then((module2) => ({
...
exports.index = index;
//# sourceMappingURL=index-C0B_UAOI.js.map
