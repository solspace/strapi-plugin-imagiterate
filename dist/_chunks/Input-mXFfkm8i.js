...
const index = require("./index-bcSO-vOL.js");
...
const Input = React__namespace.forwardRef((props, ref) => {
  ...
  const [images, setImages] = React__namespace.useState(externalImages);
  const [embeddedFromWidget, setEmbeddedFromWidget] = React__namespace.useState(false);
  const [activeImageIndex, setActiveImageIndex] = React__namespace.useState(0);
  const [enlargedImage, setEnlargedImage] = React__namespace.useState(null);
  ...
  const [resultImageUrl, setResultImageUrl] = React__namespace.useState("");
...
exports.Input = Input;
//# sourceMappingURL=Input-mXFfkm8i.js.map
