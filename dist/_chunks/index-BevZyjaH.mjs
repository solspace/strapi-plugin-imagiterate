...
const index = {
  register(app) {
    ...
    app.widgets.register({
      ...
      component: async () => {
        const component = await import("./ImagiterateWidget-FoChgyZl.mjs");
    ...
    app.customFields.register({
      ...
      icon: AiIcon,
      components: {
        Input: async () => import("./Input-CoTCK7oi.mjs").then((module) => ({
  ...
  async registerTrads({ locales }) {
    const importedTrads = await Promise.all(
      locales.map((locale) => {
        return __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/en.json": () => import("./en-CyOTrHUx.mjs") }), `./translations/${locale}.json`, 3).then(({ default: data }) => {
          return {
...
//# sourceMappingURL=index-BevZyjaH.mjs.map
