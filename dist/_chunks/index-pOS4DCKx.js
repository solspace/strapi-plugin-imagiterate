...
const index = {
  register(app) {
    ...
    app.customFields.register({
      ...
      icon: AiIcon,
      components: {
        Input: async () => Promise.resolve().then(() => require("./Input-CySD8gIz.js")).then((module2) => ({
  ...
  async registerTrads({ locales }) {
    const importedTrads = await Promise.all(
      locales.map((locale) => {
        return __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/en.json": () => Promise.resolve().then(() => require("./en-BDfYZ53R.js")) }), `./translations/${locale}.json`, 3).then(({ default: data }) => {
          return {
...
exports.index = index;
//# sourceMappingURL=index-pOS4DCKx.js.map
