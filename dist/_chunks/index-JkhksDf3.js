...
const index = {
  register(app) {
    ...
    app.widgets.register({
      ...
      component: async () => {
        const component = await Promise.resolve().then(() => require("./ImagiterateWidget-DjIitHWK.js"));
    ...
    app.customFields.register({
      ...
      icon: AiIcon,
      components: {
        Input: async () => Promise.resolve().then(() => require("./Input-Dhk41EbX.js")).then((module2) => ({
...
exports.index = index;
//# sourceMappingURL=index-JkhksDf3.js.map
