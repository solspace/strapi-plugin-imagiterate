...
const index = {
  register(app) {
    ...
    app.customFields.register({
      ...
      icon: AiIcon,
      components: {
        Input: async () => import("./Input-CipfBUhs.mjs").then((module) => ({
  ...
  async registerTrads({ locales }) {
    const importedTrads = await Promise.all(
      locales.map((locale) => {
        return __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/en.json": () => import("./en-DuIZxqTg.mjs") }), `./translations/${locale}.json`, 3).then(({ default: data }) => {
          return {
...
//# sourceMappingURL=index-C79Mqoab.mjs.map
