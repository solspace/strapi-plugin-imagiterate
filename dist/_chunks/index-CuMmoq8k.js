...
const index = {
  register(app) {
    ...
    app.widgets.register({
      ...
      component: async () => {
        const component = await Promise.resolve().then(() =>
          require("./ImagiterateWidget2-tscCvXDX.js"),
        );
    ...
    app.customFields.register({
      ...
      components: {
        Input: async () =>
          Promise.resolve()
            .then(() => require("./Input-CmCiTjOF.js"))
            .then((module2) => ({
        ...
        return __variableDynamicImportRuntimeHelper(
          /* @__PURE__ */ Object.assign({
            "./translations/en.json": () =>
              Promise.resolve().then(() => require("./en-DUZW5-cx.js")),
          }),
...
exports.index = index;
//# sourceMappingURL=index-CuMmoq8k.js.map
