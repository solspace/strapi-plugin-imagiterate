...
const Input = require("./Input-CgepHLOa.js");
...
const ImagiterateWidget2 = () => {
  ...
  if (error) return /* @__PURE__ */ jsxRuntime.jsx(Widget.Error, { children: error });
  if (!images || images.length === 0) return /* @__PURE__ */ jsxRuntime.jsx(Widget.NoData, {});
...
//# sourceMappingURL=ImagiterateWidget-DYa45XrI.js.map
