...
import { P as PLUGIN_ID } from "./index-BKnj3KTs.mjs";
          ...
          /* @__PURE__ */ jsxs(CardBody, { children: [
            /* @__PURE__ */ jsxs(
              Grid.Root,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxs(Grid.Item, { col: 7, xs: 12, children: [
                    /* @__PURE__ */ jsx(
                      Box,
                      {
                        style: {
                        ...
                        children: images.length === 0 ? /* @__PURE__ */ jsx(
                          Box,
                          {
                    ...
                    embeddedFromWidget && /* @__PURE__ */ jsx(Box, { children: /* @__PURE__ */ jsxs(Field.Root, { name: "file", children: [
                      /* @__PURE__ */ jsx(Field.Label, { children: /* @__PURE__ */ jsx(Language, { id: "uploadFile" }) }),
                      /* @__PURE__ */ jsx(
                        Field.Input,
                        {
                          type: "file",
...
//# sourceMappingURL=Input-D9TpKT4h.mjs.map
