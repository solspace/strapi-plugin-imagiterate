...
const index = {
  register(app) {
    ...
    app.widgets.register({
      ...
      component: async () => {
        const component = await import("./ImagiterateWidget-7FMDWx1M.mjs");
    ...
    app.customFields.register({
      ...
      components: {
        Input: async () =>
          import("./Input-BIgapT7n.mjs").then((module) => ({
      ...
      locales.map((locale) => {
        return __variableDynamicImportRuntimeHelper(
          /* @__PURE__ */ Object.assign({
            "./translations/en.json": () => import("./en-C8D5pRLi.mjs"),
          }),
...
//# sourceMappingURL=index-BmttQ-O5.mjs.map
