...
import ReactDOM, {
  unstable_batchedUpdates as unstable_batchedUpdates$1,
} from "react-dom";
import { EmptyDocuments } from "@strapi/icons/symbols";
import { FormattedMessage, useIntl } from "react-intl";
import { styled, createGlobalStyle } from "styled-components";
import { Input } from "./Input-Ck3pIu7O.mjs";
var commonjsGlobal =
    ...
    (t2.Provider =
      ...
      ({ value: e2, children: r3 }) => {
        ...
        return (
          ...
          createElement(o2, { value: f2.current }, r3)
        );
      })),
    delete t2.Consumer,
    t2
...
function buildHooks(_c) {
  ...
  function buildQueryHooks(name) {
    ...
    var useQueryState = function (arg, _c2) {
      ...
      var selectDefaultResult = useMemo(
        function () {
  ...
  function buildMutationHook(name) {
    return function (_c2) {
      ...
      var triggerMutation = useCallback(
        function (arg) {
...
var reactHooksModule = function (_c) {
  var _d = {},
    _e = _d.batch,
    batch = _e === void 0 ? unstable_batchedUpdates$1 : _e,
    _f = _d.useDispatch,
...
const createStepComponents = (tourName) => ({
  Root: /* @__PURE__ */ React.forwardRef(
...
const ImagiterateWidget2 = () => {
  ...
  if (error) return /* @__PURE__ */ jsx(Widget.Error, { children: error });
...
export { ImagiterateWidget2 as default };
//# sourceMappingURL=ImagiterateWidget-D57ZQdeu.mjs.map
