...
const index = {
  register(app) {
    ...
    app.widgets.register({
      ...
      component: async () => {
        const component = await import("./ImagiterateWidget-B2QrWan-.mjs");
    ...
    app.customFields.register({
      ...
      components: {
        Input: async () =>
          import("./Input-2Tm61CoF.mjs").then((module) => ({
      ...
      locales.map((locale) => {
        return __variableDynamicImportRuntimeHelper(
          /* @__PURE__ */ Object.assign({
            "./translations/en.json": () => import("./en-GC7iPJwN.mjs"),
          }),
...
//# sourceMappingURL=index-D-mnQJjn.mjs.map
